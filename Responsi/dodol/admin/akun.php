<?php
$id=get("id");
$query=sel("tpelanggan where email_pelanggan='$email_pelanggan'");
$data=far($query);
?>
<div class="container">
...
<div class="thumbnail">
<center><td><a href="?page=pelanggan_ubah&aksi=ubah&id=<?=$data['email_pelanggan']?>"><input type='button' class='btn btn-default btn-lg' value='Edit'></a></td></center>
<br>
